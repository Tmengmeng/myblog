...
function fenye($page,$page_num,$count_num){
    ...
    if($page == 1){
        $first_string = "<a href='javascript:;' id='first_page' name='1'>首页</>";
        $prev_string = "<a href='javascript:;' id='prev_page'>上一页</>";
    }else {
        $first_string = "<a href='javascript:;' id='first_page' name='1'>首页</>";
        $prev_string = "<a href='javascript:;' id='prev_page'>上一页</>";
    }
    ...
    for($i = $start;$i<=$end;$i++){
        if($i == $page){
            $centerStr.="<a class='numa active' href='javascript:;' name='{$i}'>{$i}</a>";
        }else{
            $centerStr.="<a class='numa' href='javascript:;' name='{$i}'>{$i}</a>";
        }
    }
    //尾部省略号显示
    ...
    if($page == $count_page){
        $last_string ="<a href='javascript:;' id='end_page' name='{$count_page}'>尾页</>";
        $next_string = "<a href='javascript:;' id='next_page'>下一页</>";
    }else{
        $last_string ="<a href='javascript:;' id='end_page' name='{$count_page}'>尾页</>";
        $next_string ="<a href='javascript:;' id='next_page'>下一页</>";
    }
